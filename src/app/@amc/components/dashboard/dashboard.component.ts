...
export default class DashboardComponent {
  ...
  categoryDoughnutChartData: any;  // For "All Categories"
  claimedDoughnutChartData: any;   // For "Claimed vs Unclaimed"
  // cdRef: any
...
forceUpdate(): void {
 ...
 // 1. Fetch All Categories Data
 fetchCategoryData(month: number, year: number): void {
  this.claimService.categoryItems(month.toString(), year).subscribe((res: any) => {
